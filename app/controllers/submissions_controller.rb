class SubmissionsController < ApplicationController
  ...
  # POST /submissions.json
	#
  def create
		@submission = @artist.submissions.new

		@submission.slide = submission_upload_params[:file]
  ...
  def destroy
    @submission.destroy
    respond_to do |format|
			format.html { redirect_to artist_submissions_path(@artist) }
      format.json { head :ok }
    end
  end
  ...
  private
    ...
    def submission_params
      params.require(:submission).permit(:title, :year, :medium, :price)
    end
